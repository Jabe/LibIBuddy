    ...
    class iBuddy
    {
        ...
        public bool Init(string HidDevicePath)
        {
            ...
            if (_hidFileHandle == -1)
            {
                ...
                Trace.WriteLine(string.Format("LibIBuddy: CreateFile result=-1, GetLastWin32Error()={0}", LastWin32Error));
                return false;
            }
        ...
        */
        private void UpdateState()
        {
            ...
            if (IsAlive)
            {
                ...
                {
                    LastWin32Error = Marshal.GetLastWin32Error();
                    Trace.WriteLine(string.Format("LibIBuddy: WriteFile result=0, GetLastWin32Error()={0}", LastWin32Error));
                    IsAlive = false;
                }
            }
        }
